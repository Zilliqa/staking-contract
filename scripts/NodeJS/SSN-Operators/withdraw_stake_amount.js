...
const WITHDRAW_AMOUNT = units.toQa('20', units.Units.Zil); // stake amount to be withdrawn defined in Zil converted to Qa
...
async function main() {
    ...
    console.log("------------------------ begin withdraw stake amount ------------------------\n");
    try {
    ...
    console.log("------------------------ end withdraw stake amount ------------------------\n");
}
